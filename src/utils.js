...
export function getValid(val, defaultVal) {
...
export function pathExists(url) {
...
export function debugLine(parent, start, end, color) {
...
export function removeListeners(dispatcher, type) {
...
export function getMeasurementIcon(measurement) {
...
export async function loadShapefileFeatures(file, callback) {
	let features = [];
...
export const screenPass = new class {
